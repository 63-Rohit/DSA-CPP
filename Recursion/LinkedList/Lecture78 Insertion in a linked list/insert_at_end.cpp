...
// Because if you move Head, you will lose the starting point of the linked list.We use a temporary pointer for traversal because moving the head pointer will destroy the reference to the linked list.
while(temp!=NULL)
